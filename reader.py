...
def preprocessing(text):
    # the 'split()' method when 'sep' argument is not given 
    # it will simply make a separation for every whitespace 
    # By the other hand, the 'join()' method will create
    # between every word a space.
